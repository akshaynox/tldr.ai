...
export const HeroSection = () => {
  return (
    <section className="animate-in relative z-0 mx-auto flex max-w-7xl flex-col items-center justify-center py-16 transition-all sm:py-20 lg:px-12 lg:pb-28">
      <div className="animate-gradient-x group relative overflow-hidden rounded-full bg-linear-to-r from-rose-200 via-rose-500 to-rose-800 p-px">
        <Badge
          variant="secondary"
      ...
      <h1 className="py-6 text-center font-bold">
        ...
        <span className="relative inline-block">
          <span className="relative z-10 px-2 text-rose-500">concise</span>{" "}
          <span
