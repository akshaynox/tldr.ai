  ...
  return (
    <section className="relative overflow-hidden bg-gray-50">
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 lg:py-24">
        ...
        >
          <div
            className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-linear-to-br from-emerald-500 via-teal-500 to-cyan-500 opacity-20 sm:left-[40%+30rem] sm:w-[40.1875rem]"
            style={{
              clipPath:
  ...
  return (
    <div className="group relative w-full rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-xs transition-colors hover:border-rose-500/50">
      <div className="flex h-full flex-col gap-4">
        <div className="mx-auto flex size-24 items-center justify-center rounded-2xl bg-linear-to-br from-rose-500/10 to-transparent transition-colors group-hover:from-rose-500/20">
